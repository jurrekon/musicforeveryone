...
namespace ManageEmployees.Migrations
{
    ...
    [Migration("20171213102426_initial")]
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 13, 11, 24, 26, 78, DateTimeKind.Local));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 13, 11, 24, 26, 77, DateTimeKind.Local));
            ...
            modelBuilder.Entity("ManageEmployees.Models.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTime>("BirthDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 12, 13, 11, 24, 26, 44, DateTimeKind.Local));
